...
public class SpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerControllerScript = _player.GetComponent<PlayerController>();
    ...
    void SpawnObjects()
    {
        ...
        Vector3 spawnLocation = new Vector3(_player.transform.position.x + _spawnDistance, Random.Range(1.0f,3.0f), 11);
